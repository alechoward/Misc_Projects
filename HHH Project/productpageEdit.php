...
var array = $.merge([prodkeyarray],[quantity],[Pricearray])

//[prodkeyarray,Pricearray,quantity];
document.getElementById('PrimK').innerHTML = array;
}
  //var userInput = document.getElementById('PRICE').selectedIndex;
 // document.getElementById('boldStuff2').innerHTML = userInput;
    	...
    	<div class="large-3 large-5 columns">
            ...
            <li style="list-style: none;"> <em id='PrimK'> 0 </em></li>
                      ...
                      <a href="#" class="small button" onclick='addtocart()'>Add to Cart</a><br>
